...
router.post('/home/v1/tiles', validator, rateLimitMiddleware, async (req, res) => {
    const homeDbPath = path.resolve(__dirname, '../data/homedb/home-360.json');
                                ...
                                Promise.all(fileStatsPromises).then(fileStats => {
                                    ...
                                    updatedTileList[updatedTileList.length - 4] = {
                                        ...
                                        "newsTileInfo": {
                                            ...
                                            "text": textLines.join(''),                                          
					    "imageUrl": "https://jdmo-cdn.c0llydoll.com/public/homedb/brat/home_tile_asset_article_360.jpg",
